 ...
 */
public class OrderPreparationServiceImplNew extends GenericService implements OrderPreparationService {
    ...
    private OrderPreparationServiceImplNew(DaoFactory daoFactory) {
        super(daoFactory);
    }

    private static class InstanceHolder {
        private static final OrderPreparationService instance =
                new OrderPreparationServiceImplNew(DaoFactoryImpl.getInstance());
    }
    ...
    public Order prepareOrder(Order preOrder) {
        ...
        return executeInSerializableTransactionalWrapper(connection -> {
