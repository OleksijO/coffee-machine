 ...
 */
public class UserServiceImplNew extends GenericService implements UserService {
    ...
    private UserServiceImplNew(DaoFactory daoFactory) {
        super(daoFactory);
    }

    private static class InstanceHolder {
        private static final UserService instance = new UserServiceImplNew(DaoFactoryImpl.getInstance());
    }
    ...
    public Optional<User> getById(int id) {
        ...
        return executeInNonTransactionalWrapper(
                connection ->
                        daoFactory
    ...
    public User getUserByLoginData(LoginData loginData) {
        ...
        return executeInNonTransactionalWrapper(connection ->
                daoFactory.getUserDao(connection).getUserByLogin(loginData.getEmail())
    ...
    public List<User> getAllNonAdminUsers() {
        ...
        return executeInNonTransactionalWrapper(connection ->
                daoFactory.getUserDao(connection)
                        .getAllByRole(USER)
        );
    }
