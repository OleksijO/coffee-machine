...
public final class PagesPaths {
	...
	public static final String USER_LOGIN_SUBMIT_PATH = USER + LOGIN + SUBMIT;
	...
	public static final String ADMIN_LOGIN_SUBMIT_PATH = ADMIN + LOGIN + SUBMIT;
	...
	public static final String USER_PURCHASE_SUBMIT_PATH = USER + PURCHASE + SUBMIT;
	...
	public static final String ADMIN_REFILL_SUBMIT_PATH = ADMIN + SUBMIT + REFILL;
