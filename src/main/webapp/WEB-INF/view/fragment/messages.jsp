...
<c:set var="usual_message" value="${requestScope[Attributes.USUAL_ADDITIONAL_MESSAGE]}"/>
<c:set var="usual_additional_message" value="${requestScope[Attributes.USUAL_ADDITIONAL_MESSAGE]}"/>
<c:set var="err_message" value="${requestScope[Attributes.ERROR_ADDITIONAL_MESSAGE]}"/>
